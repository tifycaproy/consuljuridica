...
<div class="col-12 position-fixed h-100 d-flex justify-content-center aling-items-center" style="background-color: white; z-index: 9999; top: 0px; opacity: .9 ">
	<div style="height: 50%;overflow: hidden;" class="mt-5 pt-5">
		<img src="{{ asset('images/fail.gif') }}" class="" style="margin-top: -30px" alt=""> <br>
		<div class="text-center">Trámite Fallido</div>
	</div>
