...
<div class="row">
 ...
 {{ csrf_field() }}
          ...
          <div class="row">
          <h4 class="title col-12 {{ $errors->has('url_imagen') ? ' has-error' : '' }}">Secciones: </h4>
          @foreach($secciones as $seccion)
          <div class="col-md-1">
            <div class="form-group bmd-form-group {{ $errors->has('posicion_seccion[]') ? ' has-error' : '' }}">

              {!! Form::label('posicion_seccion[]', 'Posición') !!}
              <input type="tel" name="posicion_seccion[]" class="form-control p{{$seccion->id}}" value="" >
          ...
          <div class="col-md-2">
            <div class="form-group bmd-form-group {{ $errors->has('seccion_id[]') ? ' has-error' : '' }}">
              ...
              <label  id="seccion_id_ch[]" class="form-check-label">
                <input id="seccion_id[]" name="seccion_id[]" value="{{$seccion->id}}" @if($seccion->id == 3) required="" @elseif($seccion->id == 5) required="" @endif  class="form-check-input check" type="checkbox">
