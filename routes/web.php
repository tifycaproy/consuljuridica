...
Route::get('servicios/{id}', ['as'=> 'servicios', 'uses'=> 'Frontend\homeController@servicios']);
...
Route::get('tramite/{id}', ['as'=>'tramite','uses'=>'Frontend\homeController@tramite']);

Route::get('preguntasF', 'Frontend\homeController@preguntas')->name('preguntasF');
...
//REGISTRAR TRAMITE
Route::post('registro_tramite', 'Frontend\homeController@registrar')->name('registro_tramite');
////
//PASARELA OK
Route::get('pasarelaOk/{id}/{res}',[
  'as' => 'pasarelaOk',
  'uses'=>'Frontend\homeController@pasarelaOK'
]);

Route::get('pasarelaKo/{id}/{res}',[
  'as' => 'pasarelaKo',
  'uses'=>'Frontend\homeController@pasarelaKO'
]);
Route::post('pasarelaOk/{id}/{res}',[
  'as' => 'pasarelaOk',
  'uses'=>'Frontend\homeController@pasarelaOK'
]);

Route::post('pasarelaKo/{id}/{res}',[
  'as' => 'pasarelaKo',
  'uses'=>'Frontend\homeController@pasarelaKO'
]);

//VER PDF
Route::get('solicitudPDF/{id}/{solicitud}/{servicio}',[
    'as' => 'solicitudPDF',
    'uses'=> 'Frontend\homeController@pdf'
]);


Route::get('solicitudPDFBack/{id_servicio}/{id_solicitud}/{id_solicitante}',[
    'as' => 'solicitudPDFBack',
    'uses'=> 'Frontend\homeController@pdfBack'
]);
// BACKEND
App::setLocale("es");
