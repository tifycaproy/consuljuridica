                  ...
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="#porPagar" data-toggle="tab">
                            <i class="material-icons">not_interested</i> Cancelado
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>
                      ...
                      <div class="tab-pane" id="porPagar">
                          <table class="table">
                            ...
                            @endphp
                              ...
                              @if($solicitantesdato["status"]=="porPagar")
                              @php
                                  $vista1=1
                              @endphp                              
                              @endif                                
                              ...
                              <thead class=" text-primary">
                                ...
                                <tbody>    
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        @foreach ($solicitantesdato["tipo_tramite"] as $tipo_tramite)
                                            {{$tipo_tramite}} <br>
                                        @endforeach                                        
                                      </td>
                                      <td>
                              ...
                              <thead class=" text-primary">
                                  <tr><th>
                                    No Posee Trámites Sin Cancelar
                                  </th>
                                </tr></thead>
                              @endif         
                          </table>
                                ...
                                <tbody>    
                                  ...
                                  <tr>
                                      ...
                                      <td class="td-actions">
                                        ...
                                        <button type="button" rel="tooltip" title="" onclick="location.href='{{ route('solicitudPDFBack',[$solicitantesdato['id_servicio'],$solicitantesdato['id_solicitud'],$solicitantesdato['id_solicitante']])}}'" class="btn btn-white btn-link btn-sm" data-original-title="Generar PDF">
